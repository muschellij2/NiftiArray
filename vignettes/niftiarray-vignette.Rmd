...
We are working to get a stable version on [Neuroconductor](www.neuroconductor.org) and [Bioconductor](www.bioconductor.org).
...
patient01 = NiftiArray::writeNiftiArray(fileinfo$nii_destination[1], filepath = tempfile(pattern = 'NiftiArraypatient01', fileext = ".h5"))
...
You could write these objects out as NIfTI's using `RNifti::writeNifti`
